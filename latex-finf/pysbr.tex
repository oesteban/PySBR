...
The shape features used for registration are twofold:
...
In summary, this feature extraction results in three landmark sets: the static landmarks \lm{static} on the 
