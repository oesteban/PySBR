...
\newacronym{t1}{T1}{T1-weighted MRI}
...
However, quantification protocols generally lack of a structural reference
  (e.g. T1-weighted MRI) for high-standard accuracy.
...
\tiny
  \section{Keywords:} non-linear registration, spect, pet, quantification, movement disorders
\end{abstract}
