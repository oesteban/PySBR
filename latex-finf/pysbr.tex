...
\begin{abstract}
\section{}
In this work we show how rigorous evaluation pipelines can be designed
  with readily available software in Python \emph{before} the development of 
  problem-specific solutions.
To illustrate the approach, we use the clinical application of fully automated
  quantification of \gls*{spect} images, which is currently challenging
