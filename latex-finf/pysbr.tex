...
Considering that image processing requires more and more reliance on software tools, 
  ...
  results. 
Hence, establishing and the publication of the evaluation procedure is becoming an important 
  part of the publication of new image processing methods.
...
In this work we show, how such an a-priory  evaluation pipelines can be designed
...
The spatial normalization is usually performed in two steps: the
  ...
  locally improves the nonlinear registration of the \acrlongpl{roi}.
...
The procedure involves some mathematical morphology operations to reproduce the
  ...
  normally distributed noise (for further details, please see section 
